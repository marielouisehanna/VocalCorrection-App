...
# Load embeddings
embedding1 = np.load(r"VocalCorrection-App\ml_models\voice_id\me1.npy")
embedding2 = np.load(r"VocalCorrection-App\ml_models\voice_id\dako.npy")
...
uncertain_threshold = 0.75  # Gray area
